...
const SUPABASE_CONFIG = {
  url: 'https://cahsygrigqfxsfbsxpbb.supabase.co',
  anonKey: 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImNhaHN5Z3JpZ3FmeHNmYnN4cGJiIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NjcwNjQ1MjMsImV4cCI6MjA4MjY0MDUyM30.Uww8218wqQiKmgT359CR1Ez8ql2HtWFvrHG4cegJAlI',
};

// Hardcoded Admin Credentials (temporary only)
const ADMIN_USERS = [
  {
    username: 'admin1',
    password: 'Admin@123',
...
// Default Per-Room Capacity Configuration
